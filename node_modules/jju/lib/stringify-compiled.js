...
function _stringify(object, options, recursiveLvl, currentKey) {
  ...
  function _stringify_nonobject(object) {
    ...
    switch (typeof object === 'undefined' ? 'undefined' : _typeof(object)) {
      ...
      case 'number':
        ...
        if (!json5 && !_Number$isFinite(object)) {
  ...
  if ((typeof object === 'undefined' ? 'undefined' : _typeof(object)) === 'object') {
    ...
    if (object === null) return 'null';
    if ((typeof object === 'undefined' ? 'undefined' : _typeof(object)) !== 'object') return _stringify_nonobject(object);
...
module.exports.stringify = function stringifyJSON(object, options, _space) {
  ...
  if (_typeof(options.indent) === 'object') {
