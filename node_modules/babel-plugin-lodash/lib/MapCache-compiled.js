...
var _get = function get(object, property, receiver) {
  if (object === null) object = Function.prototype;var desc = _Object$getOwnPropertyDescriptor(object, property);if (desc === undefined) {
    var parent = _Object$getPrototypeOf(object);if (parent === null) {
      return undefined;
    } else {
...
var MapCache = function (_Map) {
  ...
  function MapCache() {
    ...
    return _possibleConstructorReturn(this, (MapCache.__proto__ || _Object$getPrototypeOf(MapCache)).apply(this, arguments));
  }

  _createClass(MapCache, [{
    key: 'clear',
    value: function clear() {
      _get(MapCache.prototype.__proto__ || _Object$getPrototypeOf(MapCache.prototype), 'clear', this).call(this);
      return this;
    }
  }, {
    key: 'findKey',
